...
demultiplex demux -r -m5 -d -p /group/jrigrp11/cstark/namRILS_GBS/rawReads_demuxByName/. /group/jrigrp11/cstark/RossIbarra_PHG_Notes//testMicahPHGwithNAMrils/sampleNamesBarcodes.txt \
