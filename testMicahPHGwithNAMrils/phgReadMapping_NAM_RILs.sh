...
#SBATCH -o /group/jrigrp11/cstark/namRIL_GBS/phgNamRILSmapping_20241119_%j.sbatch.out
#SBATCH -e /group/jrigrp11/cstark/namRIL_GBS/phgNamRILSmapping_20241119_%j.sbatch.err
#SBATCH -t 24:00:00
