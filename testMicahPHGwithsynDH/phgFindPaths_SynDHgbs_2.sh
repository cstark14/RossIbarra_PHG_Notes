...
#SBATCH -J phgReadMap_SynDHgbs_2
...
phg map-kmers \
    ...
    --key-file /group/jrigrp11/cstark/synDHfastqPHGmapped/fastqList2_phgMappingKeyFile.txt \
    --output-dir /group/jrigrp11/cstark/synDHfastqPHGmapped/ > /group/jrigrp11/cstark/mappingfastqList2_20241021.out 2> /group/jrigrp11/cstark/mappingfastqList2_20241021.err